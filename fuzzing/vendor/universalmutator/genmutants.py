...
try:
    # Optional dependency used only for `--printStat`.
    from tabulate import tabulate  # type: ignore
except ModuleNotFoundError:  # pragma: no cover
    def tabulate(table, tablefmt=None, **kwargs):  # type: ignore
        # Minimal fallback (not as pretty as `tabulate`, but avoids the dependency).
